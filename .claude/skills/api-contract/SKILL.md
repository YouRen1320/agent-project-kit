...
1. Read `../../../.agents/references/api-contract.md` completely.
2. Read `../../../.agents/project/api-conventions.md` for repository-specific conventions.
...
5. For breaking contracts and cross-component changes, read `../../../.agents/workflows/module-delivery.md`, compare options, and wait for confirmation before implementation.
